...
public final class MurmurHash3 {
  ...
  public static final class LongPair {
    ...
    private LongPair(long val1, long val2) {
      this.val1 = val1;
      this.val2 = val2;
    }
  ...
  public static void main(String[] args) {
    ...
    LongPair longPair = MurmurHash3.murmurhash3_x64_128(bytes, 0, bytes.length, Arrays.hashCode(bytes));
    System.out.println(Arrays.hashCode(bytes));
    System.out.println(longPair.val1);
    System.out.println(Long.toBinaryString(longPair.val1));
  }
